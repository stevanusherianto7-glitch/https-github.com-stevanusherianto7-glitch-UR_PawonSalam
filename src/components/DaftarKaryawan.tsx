    ...
    <div className="p-6">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_15px_-5px_rgba(0,0,0,0.05)]">
        <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-pink-50 rounded-t-lg">
          <h2 className="text-2xl font-bold text-slate-700">Daftar Karyawan</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  { id: 1, nik: '', partner: 'Pawon Salam', nama: 'Endi Boston Sitompul', email: 'pawonsalambandung@gmail.com', noTelp: '08161191561', level: 'Owner' },
                  { id: 2, nik: '', partner: 'Pawon Salam', nama: 'UR Dev', email: 'gagas@dev.com', noTelp: '', level: 'Owner' },
                  { id: 3, nik: '', partner: 'Pawon Salam', nama: 'Ana', email: 'anajumnanikwidyama@gmail.com', noTelp: '085640028589', level: 'Manager' },
                  { id: 4, nik: '', partner: 'Pawon Salam', nama: 'Veronica Dhian', email: 'veronicadr2014@gmail.com', noTelp: '', level: 'Owner' },
                  { id: 5, nik: '', partner: 'Pawon Salam', nama: 'Sansan', email: 'mhmmmfznn26@gmail.com', noTelp: '088802116155', level: 'Kasir' },
                ].map((item, index) => (
                  <tr key={item.id} className={`hover:bg-gray-50 transition-colors ${index % 2 !== 0 ? 'bg-gray-50' : ''}`}>
                    ...
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.nik}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.partner}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.nama}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.email}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.noTelp}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.level}</td>
