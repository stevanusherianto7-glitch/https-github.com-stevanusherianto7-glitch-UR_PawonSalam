    ...
    <div className="p-6">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_15px_-5px_rgba(0,0,0,0.05)]">
        <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-pink-50 rounded-t-lg">
          <h2 className="text-2xl font-bold text-slate-700">Daftar Hak Akses</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  { id: 1, nama: 'Manager', jumlahKaryawan: '3', maksimalDiskon: '100%', akses: 'Web dan Aplikasi' },
                  { id: 2, nama: 'Owner', jumlahKaryawan: '3', maksimalDiskon: '100%', akses: 'Web dan Aplikasi' },
                  { id: 3, nama: 'Kasir', jumlahKaryawan: '5', maksimalDiskon: '0%', akses: 'Aplikasi saja' },
                ].map((item, index) => (
                  <tr key={item.id} className={`hover:bg-gray-50 transition-colors ${index % 2 !== 0 ? 'bg-gray-50' : ''}`}>
                    ...
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.jumlahKaryawan}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.maksimalDiskon}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.akses}</td>
