...
export default function MetodePembayaran() {
  const data = [
    { no: 1, nama: 'OVO', active: true },
    { no: 2, nama: 'GOPAY', active: true },
    { no: 3, nama: 'DANA', active: true },
    { no: 4, nama: 'LINKAJA', active: true },
    { no: 5, nama: 'TUNAI', active: true },
  ];
    ...
    <div className="p-6">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_15px_-5px_rgba(0,0,0,0.05)]">
        <div className="p-4 border-b border-gray-200 bg-pink-50 rounded-t-lg flex justify-between items-center">
          <h2 className="text-2xl font-bold text-slate-700">Metode Pembayaran</h2>
          ...
          <table className="w-full text-sm text-left text-gray-700">
            <thead className="text-xs text-gray-700 bg-white border-b border-gray-200">
              <tr>
                ...
                <th scope="col" className="px-6 py-4 font-semibold">Metode Pembayaran</th>
              ...
              {data.map((item, index) => (
                <tr key={index} className="bg-white border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 flex space-x-2">
                    <span className="bg-pink-600 text-white text-[10px] px-2 py-0.5 rounded font-bold">UR</span>
                    <span className="bg-pink-600 text-white text-[10px] px-2 py-0.5 rounded font-bold">Aktif</span>
                  </td>
                </tr>
              ))}
            </tbody>
