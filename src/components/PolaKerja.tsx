...
export default function PolaKerja() {
  return (
    <div className="p-6">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_15px_-5px_rgba(0,0,0,0.05)]">
        <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-pink-50 rounded-t-lg">
          <h2 className="text-2xl font-bold text-slate-700">Daftar Pola Kerja</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  { id: 1, nama: 'Shift pagi', senin: '07:00:00 - 14:00:00', selasa: '07:00:00 - 14:00:00', rabu: 'Libur', kamis: 'Libur', jumat: 'Libur', sabtu: 'Libur', minggu: 'Libur' },
                ].map((item, index) => (
                  <tr key={item.id} className={`hover:bg-gray-50 transition-colors ${index % 2 !== 0 ? 'bg-gray-50' : ''}`}>
                    ...
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.senin}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.selasa}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.rabu}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.kamis}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.jumat}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.sabtu}</td>
                    <td className="py-3 px-4 text-gray-800 text-sm">{item.minggu}</td>
