...
export default function PemasukanService() {
  ...
  return (
    <div className="p-8 bg-[#FAFAFA] min-h-full flex flex-col">
      <div id="service-report" className="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_15px_-5px_rgba(0,0,0,0.05)] overflow-hidden flex-1 flex flex-col items-start w-full">
        {/* Header */}
        <div className="bg-[#fdf2f8] w-full px-6 py-4 border-b border-gray-200 flex justify-between items-center shrink-0">
          <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Service</h2>
          ...
          <table className="w-full text-left text-[13px] text-gray-700">
            <tbody>
              <tr className="border-b border-t border-gray-200">
                <td className="py-4 px-4 font-bold text-gray-800 w-64">Persentase Service</td>
                <td className="py-4 px-4">0%</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="py-4 px-4 font-bold text-gray-800">Jumlah Kena Service</td>
                <td className="py-4 px-4">{formatRupiah(711408)}</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="py-4 px-4 font-bold text-gray-800">Service dipungut</td>
